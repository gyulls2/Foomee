...
const WelcomeModal: React.FC<Props> = ({ setIsOpened }) => {
  ...
  const handleMoveToStep1 = () => {
    setIsOpened(false);
    router.push('/signup/step1');
  };

  return (
    <div className="overflow-hidden fixed w-[475px] h-full top-0 bg-black/70 z-10 flex items-center justify-center">
      <div
